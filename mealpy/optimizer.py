...
class Optimizer:
    ...
    def get_target_wrapper(self, position):
        Model=self.problem.Model_trained_Partial
        tst_data=self.problem.tst_data
        tst_lab=self.problem.tst_lab
        """
        Args:
        ...
        if self.problem.multi_args:
            ...
            objs = self.problem.fit_func(position,Model,tst_data,tst_lab)
